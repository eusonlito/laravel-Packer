...
abstract class ProviderBase implements Countable
{
    /**
     * @var string
     */
     ...
     * @param $file
     * @return array
     * @throws \Laravel\Packer\Exceptions\FileNotExistException
     */
    ...
    /**
     * @throws \Laravel\Packer\Exceptions\DirNotWritableException
     * @throws \Laravel\Packer\Exceptions\DirNotExistException
     */
    ...
    /**
     * @throws \Laravel\Packer\Exceptions\CannotRemoveFileException
     */
     ...
     * @param $minified
     * @return string
     * @throws \Laravel\Packer\Exceptions\CannotSaveFileException
     */
